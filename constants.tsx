...
export const PROJECTS: Project[] = [
  {
    ...
    imageUrl: './components/images/PrintsAdvocacia-Site/adv1.png',
    gallery: [
      './components/images/PrintsAdvocacia-Site/adv1.png',
      './components/images/PrintsAdvocacia-Site/adv2.png',
      './components/images/PrintsAdvocacia-Site/adv3.png',
      './components/images/PrintsAdvocacia-Site/adv4.png',
      './components/images/PrintsAdvocacia-Site/adv5.png',
      './components/images/PrintsAdvocacia-Site/adv6.png',
    ],
    structure: [
  ...
  },
  {
    ...
    imageUrl: './components/images/PrintsLawFirm/ADV1.png',
    gallery: [
      './components/images/PrintsLawFirm/ADV1.png',
      './components/images/PrintsLawFirm/ADV2.png',
      './components/images/PrintsLawFirm/ADV3.png',
      './components/images/PrintsLawFirm/ADV4.png',
      './components/images/PrintsLawFirm/AVD5.png',
    ],
    structure: [
  ...
  },
  {
    ...
    imageUrl: './components/images/Prints-Clinica-Vida/cli1.png',
    gallery: [
      './components/images/Prints-Clinica-Vida/cli1.png',
      './components/images/Prints-Clinica-Vida/cli2.png',
      './components/images/Prints-Clinica-Vida/cli3.png',
      './components/images/Prints-Clinica-Vida/cli4.png',
      './components/images/Prints-Clinica-Vida/cli5.png',
      './components/images/Prints-Clinica-Vida/cli6.png',
    ],
    structure: [
